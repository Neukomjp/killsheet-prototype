        ...
        <div className="flex flex-col h-full p-6 space-y-6">
            ...
            <div className="flex flex-col flex-1 space-y-3">
                ...
                {currentStep === 1 ? (
                    ...
                    <div className="flex-1 flex flex-col space-y-4 overflow-y-auto px-1 pt-2 pb-2">
                    ...
                    <div className="flex-1 flex flex-col space-y-6 overflow-y-auto px-1 pt-2 pb-2">
